...
##
##   • au-dessus, LA FACADE DU CARTON — `PLATE` moins sa propre facette. C'est
##     le fond contre lequel la tranche se detache dans la fente de 12 px entre
##     deux cartes ;
##   • en dessous, L'OMBRE PORTEE a 0,102 (`VEIL`), qui la longe sur toute sa
##     longueur.
##
## ⚠️ LE PREMIER ESSAI A 0,18 ETAIT INVISIBLE, et pour la raison exacte que §9.9
## donne a propos de `PLATE_RAISED` : il avait ete choisi contre `PLATE` en
## oubliant que la facette du carton lui reprend `FACET_DROP` (0,030). Mesure en
## capture, la tranche sortait a 46/255 contre 50 pour le carton — quatre points
## d'ecart, une carte sans epaisseur. UNE VALEUR SE CHOISIT CONTRE CE QU'ELLE
## TOUCHE REELLEMENT, jamais contre la constante dont ce voisin descend.
##
## 0,149 partageait cet ecart en deux DU TEMPS OU LE CARTON VALAIT 0,23 : facade
## a 0,197, ombre a 0,102, donc 0,05 de part et d'autre.
##
## ⛔ A REVERIFIER EN CAPTURE — LA BORNE HAUTE A BOUGE A LA FUSION DU 2026-08-20.
## La passe de contraste du 2026-08-19 a descendu `PLATE` de 0,23 a 0,18, donc
## la facade du carton de 0,197 a 0,150 : l'ecart ou cette tranche se loge passe
## de 0,095 a 0,048, et 0,149 n'en est plus le milieu mais le HAUT. Le milieu y
## serait #20201F (0,126). Les deux passes ont ete ecrites en parallele et ne se
## connaissaient pas — c'est le piege du paragraphe ci-dessus vu par l'autre
## bout : ce n'est pas la valeur qui a bouge, c'est son voisin.
##
